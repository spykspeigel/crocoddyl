...
#ifndef CROCODDYL_MULTIBODY_IMPULSES_IMPULSE_2D_HPP_
#define CROCODDYL_MULTIBODY_IMPULSES_IMPULSE_2D_HPP_
...
class ImpulseModel2DTpl : public ImpulseModelAbstractTpl<_Scalar> {
 public:
  ...
  typedef ImpulseData2DTpl<Scalar> Data;
  ...
  ImpulseModel2DTpl(boost::shared_ptr<StateMultibody> state, const std::size_t frame);
  virtual ~ImpulseModel2DTpl();
...
template <typename _Scalar>
struct ImpulseData2DTpl : public ImpulseDataAbstractTpl<_Scalar> {
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  ImpulseData2DTpl(Model<Scalar>* const model, pinocchio::DataTpl<Scalar>* const data)
      : Base(model, data),
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/impulses/impulse-2d.hxx"

#endif  // CROCODDYL_MULTIBODY_IMPULSES_IMPULSE_2D_HPP_
