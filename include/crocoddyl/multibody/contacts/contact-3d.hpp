...
struct ContactData3DTpl : public ContactDataAbstractTpl<_Scalar> {
  ...
  ContactData3DTpl(Model<Scalar>* const model, pinocchio::DataTpl<Scalar>* const data)
      : Base(model, data),
        fJf(6, model->get_state()->get_nv()-12),
        v_partial_dq(6, model->get_state()->get_nv()-12),
        a_partial_dq(6, model->get_state()->get_nv()-12),
        a_partial_dv(6, model->get_state()->get_nv()-12),
        a_partial_da(6, model->get_state()->get_nv()-12),
        fXjdv_dq(6, model->get_state()->get_nv()-12),
        fXjda_dq(6, model->get_state()->get_nv()-12),
        fXjda_dv(6, model->get_state()->get_nv()-12) {
    frame = model->get_id();
