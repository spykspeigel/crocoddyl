...
#ifndef CROCODDYL_MULTIBODY_STATES_SOFTMULTIBODY_HPP_
#define CROCODDYL_MULTIBODY_STATES_SOFTMULTIBODY_HPP_
...
class StateSoftMultibodyTpl : public StateMultibodyTpl<_Scalar> {
 public:
   ...
   */
  explicit StateSoftMultibodyTpl(boost::shared_ptr<PinocchioModel> model);
  StateSoftMultibodyTpl();
  virtual ~StateSoftMultibodyTpl();
...
/* --- Details -------------------------------------------------------------- */
/* --- Details -------------------------------------------------------------- */
#include "crocoddyl/multibody/states/soft-multibody.hxx"

#endif  // CROCODDYL_MULTIBODY_STATES_SOFTMULTIBODY_HPP_
